      ...
      <section id="pricing" className="py-16 bg-brand-blue/90 text-white">
        ...
        <div className="container mx-auto grid md:grid-cols-3 gap-6">
            ...
            <div className="p-6 flex flex-col h-full">
              ...
              <div className="mb-6">
                ...
                <div className="text-sm text-gray-500">
                  Access: Ask 1 question/month
                </div>
              </div>
              <div className="mb-6">
                <div className="text-sm text-gray-500">
                  Sale Price: $0 (Normally $10/month)
                </div>
              </div>
              <Button className="mt-auto bg-brand-gold hover:bg-amber-500 text-white">
                SIGN UP
              </Button>
            </div>
          </div>
          ...
          <div className="bg-white text-gray-800 rounded-lg overflow-hidden">
            <div className="p-6 flex flex-col h-full">
              <div className="mb-4">
                <div className="bg-brand-blue/90 text-white w-16 h-16 flex items-center justify-center rounded-lg mx-auto mb-4">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-8 w-8"
                    fill="none"
              ...
              <div className="mb-6">
                ...
                <div className="text-sm text-gray-500">
                  Access: Ask up to 30 questions/month (1 question/day)
                </div>
              </div>
              <div className="mb-6">
                <div className="text-sm text-gray-500">
                  Sale Price: $9 (Normally $19/month)
                </div>
              </div>
              <Button className="mt-auto bg-brand-gold hover:bg-amber-500 text-white">
                SIGN UP
          ...
          <div className="bg-white text-gray-800 rounded-lg overflow-hidden">
            <div className="p-6 flex flex-col h-full">
              ...
              <div className="mb-6">
                ...
                <div className="text-sm text-gray-500">
                  Access: Unlimited questions per month
                </div>
              </div>
              <div className="mb-6">
                <div className="text-sm text-gray-500">
                  Sale Price: $15 (Normally $39/month)
                </div>
              </div>
              <Button className="mt-auto bg-brand-gold hover:bg-amber-500 text-white">
                SIGN UP
